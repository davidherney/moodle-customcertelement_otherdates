...
/**
 * This file contains the customcert element other date's API.
 *
 * @package    customcertelement_otherdates
 * @copyright  2023 David Herney @ BambuCo
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace customcertelement_otherdates;
 ...
 */
define('CUSTOMCERT_SHORTDATES_FIRSTMODVIEW', '0');

/**
 * The customcert element other date's API.
 *
 * @package    customcertelement_otherdates
 * @copyright  2023 David Herney @ BambuCo
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class element extends \mod_customcert\element {
    ...
    public function render_form_elements($mform) {
        ...
        if ($completionenabled) {
            $dateoptions[CUSTOMCERT_SHORTDATES_FIRSTMODVIEW] = get_string('firstmodview', 'customcertelement_otherdates');
        }

        $mform->addElement('select', 'dateitem', get_string('dateitem', 'customcertelement_otherdates'), $dateoptions);
        $mform->addHelpButton('dateitem', 'dateitem', 'customcertelement_otherdates');

        $mform->addElement('select', 'dateformat', get_string('dateformat', 'customcertelement_otherdates'), self::get_date_formats());
        $mform->addHelpButton('dateformat', 'dateformat', 'customcertelement_otherdates');
    ...
    public function render($pdf, $preview, $user) {
        ...
        if ($preview) {
            ...
            if ($dateitem == CUSTOMCERT_SHORTDATES_FIRSTMODVIEW) {
    ...
    protected static function get_ordinal_number_suffix($day) {
        if (!in_array(($day % 100), array(11, 12, 13))) {
            switch ($day % 10) {
                // Handle 1st, 2nd, 3rd.
                case 1:
                    return get_string('numbersuffix_st_as_in_first', 'customcertelement_otherdates');
                case 2:
                    return get_string('numbersuffix_nd_as_in_second', 'customcertelement_otherdates');
                case 3:
                    return get_string('numbersuffix_rd_as_in_third', 'customcertelement_otherdates');
            }
        }
        return 'th';
    }
